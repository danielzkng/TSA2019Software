...
namespace Software_Development
{
    ...
    public class CalEvent
    {
        ...
        {
            return "Title: " + Title + Environment.NewLine + "Description: " + Description + Environment.NewLine + "CID: " + CreatorID + Environment.NewLine + "ID: " + ID + Environment.NewLine + "Date: " + Date.ToShortDateString();
        }
    }
}
